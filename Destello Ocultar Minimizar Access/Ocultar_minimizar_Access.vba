...
Sub BotonMinVisible_test()

   BotonMinVisible True

End Sub

Function BotonMinVisible(bEnable As Boolean) As Long
'-----------------------------------------------------------------------------------------------------------------------------------------------
' Fuente            : https://access-global.net/vba-ocultar-minimizar-access/
'-----------------------------------------------------------------------------------------------------------------------------------------------
' Título            : BotonMinVisible
' Autor original    : Desconocido
' Adaptado por      : Luis Viadel
' Actualizado       : abril 2011
' Propósito         : bloquea la opción minimizar la ventana de Access
' Retorno           : long
' Argumento/s       : La sintaxis del procedimiento o función consta del siguiente argumento:
'                     Parte                Modo        Descripción
'-----------------------------------------------------------------------------------------------------------------------------------------------
'                     activado          Obligatorio    El valor Boolean especifica si el botón minimizar está bloqueado o no
'-----------------------------------------------------------------------------------------------------------------------------------------------
...
If bEnable Then
 dwNewLong = (dwLong Or WS_MINIMIZEBOX)
Else
 dwNewLong = (dwLong And Not WS_MINIMIZEBOX)
End If
